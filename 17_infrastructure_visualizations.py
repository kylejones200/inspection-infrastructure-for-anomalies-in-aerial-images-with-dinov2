...
def create_main_visualization(plot: bool = False):
    ...
    # Generate embeddings
    embeddings, labels, anomaly_scores = generate_embeddings_with_structure(
        n_images=10000
    )
    ...
    if plot:
        ...
        plt.tight_layout()
        plt.savefig(
            "/Users/k.jones/Desktop/blogs/blog_posts/17_infrastructure_inspection_dinov2_main.png",
            dpi=300,
            bbox_inches="tight",
        )
        plt.close()
...
def create_anomaly_distribution_visualization(plot: bool = False):
    ...
    if plot:
        ...
        class_names = {0: "Normal", 1: "Vegetation", 2: "Equipment", 3: "Damage"}
        ...
        plt.tight_layout()
        plt.savefig(
            "/Users/k.jones/Desktop/blogs/blog_posts/17_infrastructure_anomaly_distribution.png",
            dpi=300,
            bbox_inches="tight",
        )
        plt.close()
...
def create_performance_metrics_visualization(plot: bool = False):
    ...
    if plot:
        ...
        bars2 = ax2.bar(
            metrics, values, color=colors_perf, edgecolor="black", linewidth=1.5
        )
        ...
        plt.tight_layout()
        plt.savefig(
            "/Users/k.jones/Desktop/blogs/blog_posts/17_infrastructure_performance.png",
            dpi=300,
            bbox_inches="tight",
        )
        plt.close()
